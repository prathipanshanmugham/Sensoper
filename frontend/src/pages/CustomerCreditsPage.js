    ...
    <div className="py-6 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div><h1 className="text-2xl font-bold font-['Outfit'] text-slate-900" data-testid="credits-title">Customer Credits</h1><p className="text-sm text-slate-500">Manage store credit and receivables</p></div>
          <Button onClick={() => setShowForm(true)} className="gap-2 bg-emerald-600 hover:bg-emerald-700 text-white" data-testid="new-credit-btn"><Plus className="h-4 w-4" />New Credit</Button>
        </div>
